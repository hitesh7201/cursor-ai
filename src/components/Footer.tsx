    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* Company Info */}
          <div>
            <h3 className="mb-4 text-lg font-bold">StyleHub</h3>
            <p className="mb-4 text-gray-400">
              Your destination for trendy and stylish clothing for men and women.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/categories/men" className="hover:text-white">
                  Men's Clothing
                </Link>
              </li>
              <li>
                <Link href="/categories/women" className="hover:text-white">
                  Women's Clothing
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="rounded-r-md bg-purple-600 px-4 py-2 font-medium text-white hover:bg-purple-700"
              >
                Subscribe
              </button>
            </form>
